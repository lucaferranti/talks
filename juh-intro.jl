...
# ╔═╡ b9494f74-5afb-4663-87d9-db6d7b958fff
begin
	using PlutoUI
...
# ╔═╡ 6e900de9-6594-44f0-9661-a04b741a2d5a
using UnicodePlots

# ╔═╡ 95f01272-51d4-47bc-a1d4-d8131572103f
html"<button onclick='present()'>present</button>"

# ╔═╡ 252794b0-34e3-11ed-0369-598233f524b2
html"""
<h1>Julia Users Helsinki - 2022-09-21</h1>
<center>
<img style="width: 100%;" src="https://raw.githubusercontent.com/julia-users-helsinki/julia-users-helsinki.github.io/main/page/_assets/juh-logo.svg"/>
</center>
"""

# ╔═╡ d2168709-4331-40ab-8ca6-0c52ce984060
md"""
...
- **16:15**: Fabricio Oliveira, *Teaching and research using Julia in the Gamma-opt research group*
- **16:45 -- 17:30**: free hanging out (coffee/tea available)
- **17:30**: Dinner at Fat Lizard
"""

# ╔═╡ e86a31f4-60e4-4dfd-ad20-450eccca53e3
md"""
## Introduction
- who you are, what you do, what you use Julia for, what attracted you to Julia, etc.
...
##
- [Thriving ecosystem](https://julialang.org/community/organizations/) for several applications, especially scientific computing
![](https://julialang.org/community/assets/orglogos.png)
...
# ╔═╡ 3af9246e-1e29-4d0b-aac8-169ffdea46a0
1 + 1

# ╔═╡ 30ad4cca-c7e4-47ba-8b8f-9dc7fd7f8e3b
f(x) = √3*sin(3*(x-2))

# ╔═╡ bdf7e96b-f032-4a4b-95cc-9e9f4571ad8f
plt = lineplot(f, -2π, 2π)
...
julia_version = "1.8.0"
manifest_format = "2.0"
project_hash = "b32ec7766a62275b8df5d3802272a04aeb91efa2"
...
git-tree-sha1 = "c14d0cb5132b74cd7d4ff02b551ef144e9b42396"
