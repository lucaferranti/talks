...
# ╔═╡ c3defc84-4108-4d49-8ae0-696151bcc924
using PlutoUI

# ╔═╡ f6cb4bb8-04d7-11ed-2ec7-81f52678562f
using RangeEnclosures, Plots

# ╔═╡ dd09c06b-87e0-473e-a622-bdbf6e63a332
using IntervalOptimisation

# ╔═╡ 741d19f1-adff-4fd5-b8f3-8bb74575bce6
html"""
<script>
...
# ╔═╡ bee3503a-71ab-4706-9e31-59e7bff82edc
html"""<button onclick='present()'>present</button>"""

# ╔═╡ c9eef1dc-124e-4d57-a575-ce6c6091cd99
md"""
# RangeEnclosures.jl: a flexible API to bound function ranges
*Luca Ferranti, GSoC 2022*

*JuliaCon2022*
"""

# ╔═╡ fc43906a-f7ff-4bfa-a836-6fb5720caa84
let
...
# ╔═╡ 520a9bd3-fbcb-4c06-a75c-c4513f62d4b1
f(x) = -sum(k*x*sin(k*(x-3)/3) for k in 1:5)

# ╔═╡ 69d5ac37-1e3c-4122-8762-d64193031e64
X = -10..10
...
gNE = enclose(g, Xg, NaturalEnclosure())

# ╔═╡ 3dd238d4-5c5e-48f3-801e-9dc88410d671
gMV = enclose(g, Xg, MeanValueEnclosure())
...
Xh = IntervalBox(-5..5, 2)

# ╔═╡ 9d845ae9-875f-4058-a888-7156f762e6ba
hBB = enclose(h, Xh, BranchAndBoundEnclosure())

# ╔═╡ 0663eef3-eb48-4190-b8e8-68eff00487ca
let
	x = y = -5:0.1:5
	f(x, y) = h([x, y])
	surface(x, y, [sup(hBB) for _ in x, _ in y], α=0.4, legend=:none, size=(500, 500))
...
[compat]
IntervalOptimisation = "~0.4.6"
Plots = "~1.31.2"
PlutoUI = "~0.7.39"
RangeEnclosures = "~0.1.2"
"""
...
[[deps.IntervalOptimisation]]
deps = ["IntervalArithmetic"]
git-tree-sha1 = "092ec8af500f51d4784e4c581d922a1a059f7782"
...
[[deps.RangeEnclosures]]
deps = ["ForwardDiff", "IntervalArithmetic", "Reexport", "Requires"]
git-tree-sha1 = "59e0e25dc16d63e51203771acfc25e3aa72229de"
